...
public class SnowflakeIdFactory01024Tests : SnowflakeIdFactory00000Tests
{
    ...
    [Fact]
    public void TestGetSnowflakeId1024()
    {
    ...
    [Fact]
    public void TestGetSnowflakeId1024WithNode()
    {
        var startTime = DateTimeOffset.UtcNow.ToUnixTimeMilliseconds();
    ...
    [Fact]
    public void TestGetSnowflakeIdString1024()
    {
        var startTime = DateTimeOffset.UtcNow.ToUnixTimeMilliseconds();
    ...
    [Fact]
    public void TestGetSnowflakeIdString1024WithNode()
    {
        var startTime = DateTimeOffset.UtcNow.ToUnixTimeMilliseconds();
    ...
    [Fact]
    public void TestGetSnowflakeId1024Parallel()
    {
